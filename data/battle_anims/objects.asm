...
; ANIM_OBJ_ACID
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_1D, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, ANIM_GFX_POISON
; ANIM_OBJ_SLUDGE
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_SLUDGE, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON
; ANIM_OBJ_POISON_JAB
	battleanimobj RELATIVE_X, $80, BATTLEANIMFRAMESET_4C, BATTLEANIMFUNC_FLOAT_UP, PAL_BATTLE_OB_GREEN, ANIM_GFX_CHARGE
...
; ANIM_OBJ_DRAINING_KISS
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_76, BATTLEANIMFUNC_ABSORB, PAL_BATTLE_OB_RED, ANIM_GFX_OBJECTS
; ANIM_OBJ_EGG
...
; ANIM_OBJ_SEED_BOMB
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_PLANT
; ANIM_OBJ_SWEET_KISS
...
; ANIM_OBJ_COSMIC_POWER
	battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_GROWTH_SWORDS_DANCE, PAL_BATTLE_OB_YELLOW, ANIM_GFX_OBJECTS
...
; ANIM_OBJ_MUD_BOMB
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_74, BATTLEANIMFUNC_THROW_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_BROWN, ANIM_GFX_EGG
; ANIM_OBJ_POWER_GEM
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $88, BATTLEANIMFRAMESET_5F, BATTLEANIMFUNC_NULL, PAL_BATTLE_OB_GRAY, ANIM_GFX_BEAM
; ANIM_OBJ_POWER_GEM_TIP
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $88, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_SHAKE, PAL_BATTLE_OB_GRAY, ANIM_GFX_BEAM
