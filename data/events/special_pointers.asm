...
; Map events
	...
	add_special PlayerGenderMenu
	add_special SpawnPlayer
	...
	add_special ScrollingMenu
	add_special UpdateSprites ; bank 0
	add_special UpdatePlayerSprite ; bank 0
	add_special GameCornerPrizeMonCheckDex
	add_special SubwayTrain
	add_special WaitSFX ; bank 0
	add_special PlayMapMusic ; bank 0
	add_special RestartMapMusic ; bank 0
	add_special HealMachineAnim
	add_special SurfStartStep
	add_special LoadMapPals
	add_special ApplyPals
	add_special FindPartyMonThatSpecies
	add_special FindPartyMonThatSpeciesYourTrainerID
	add_special LoadSubwayDestinations
