...
MonMenuIcons:
	...
	db ICON_SPEAROW     ; FARFETCH_D
	db ICON_TOGETIC     ; DODUO
	db ICON_TOGETIC     ; DODRIO
	db ICON_LAPRAS      ; SEEL
	...
	db ICON_VOLTORB     ; WEEZING
	db ICON_BALTOY      ; BALTOY
	db ICON_BALTOY      ; CLAYDOL
	...
	db ICON_SPEAROW     ; ARTICUNO
	db ICON_SPEAROW     ; ZAPDOS
	db ICON_SPEAROW     ; MOLTRES
