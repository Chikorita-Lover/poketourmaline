...
; Notably, Rhydon is missing (it should be before Baltoy).
...
.o:        db FERALIGATR, FURRET, OCTILLERY, BRELOOM, SENTRET, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.sa_za:    db BALTOY, PUPITAR, CORSOLA, HITMONLEE, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH, -1 ; RHYDON should lead this list
...
.ho_bo_po: db HO_OH, HOOTHOOT, PIDGEY, PONYTA, SKIPLOOM, LEAFEON, PORYGON2, -1
.ma:       db MAGCARGO, SLUGMA, QUILAVA, BELLSPROUT, WEEZING, MARILL, AZUMARILL, ELECTRODE, SHROOMISH, MANTINE, -1
