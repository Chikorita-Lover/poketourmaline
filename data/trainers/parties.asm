...
StikulraGroup:
	; STIKULRA (1)
	db "STIKULRA@", TRAINERTYPE_VARIABLE

	; No badges
	db TRAINERTYPE_MOVES
	db 12, EKANS,      WRAP, POISON_STING, DOUBLE_TEAM, NO_MOVE
	db 15, BEEDRILL,   POISON_STING, FURY_ATTACK, DOUBLE_TEAM, NO_MOVE
	db $fe ; delimiter

	; One badge
	db TRAINERTYPE_MOVES
	db 17, EKANS,      BITE, POISON_STING, DOUBLE_TEAM, LEER
	db 20, BEEDRILL,   POISON_STING, TWINEEDLE, DOUBLE_TEAM, FOCUS_ENERGY
	db $fe ; delimiter

	; Two badges
	db TRAINERTYPE_MOVES
	db 22, ARBOK,      BITE, ACID, DOUBLE_TEAM, GLARE
	db 23, GASTLY,     NIGHT_SHADE, LICK, DOUBLE_TEAM, MEAN_LOOK
	db 25, BEEDRILL,   POISON_STING, TWINEEDLE, DOUBLE_TEAM, FOCUS_ENERGY
	db $fe ; delimiter

	; Three badges
	db TRAINERTYPE_MOVES
	db 27, ARBOK,      CRUNCH, ACID, DOUBLE_TEAM, GLARE
	db 28, HAUNTER,    NIGHT_SHADE, LICK, DOUBLE_TEAM, MEAN_LOOK
	db 30, BEEDRILL,   POISON_STING, TWINEEDLE, DOUBLE_TEAM, PURSUIT
	db $fe ; delimiter

	; Four badges
	db TRAINERTYPE_MOVES
	db 32, ARBOK,      CRUNCH, ACID, DOUBLE_TEAM, GLARE
	db 33, GENGAR,    NIGHT_SHADE, LICK, DOUBLE_TEAM, MEAN_LOOK
	db 35, BEEDRILL,   POISON_STING, TWINEEDLE, DOUBLE_TEAM, PURSUIT
	db $ff ; end
...
ChuckGroup:
	...
	db 27, BRELOOM,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
...
Rival1Group:
	; RIVAL1 (1)
	db "STIKE@", TRAINERTYPE_MOVES
	db  9, PIKACHU,    TAIL_WHIP, THUNDERSHOCK, GROWL, CHARM
	db 11, SANDSHREW,  SCRATCH, RAPID_SPIN, FURY_CUTTER, POISON_STING
	db -1 ; end

	; RIVAL1 (2)
	db "STIKE@", TRAINERTYPE_MOVES
	db 15, HERACROSS,  TACKLE, LEER, HORN_ATTACK, ENDURE
	db 16, PIKACHU,    TAIL_WHIP, THUNDERSHOCK, QUICK_ATTACK, CHARM
	db 16, SANDSHREW,  SCRATCH, ROLLOUT, MAGNITUDE, POISON_STING
	db -1 ; end

	; RIVAL1 (3)
	db "STIKE@", TRAINERTYPE_MOVES
	db 22, QWILFISH,   TACKLE, POISON_STING, SPIKES, BUBBLE
	db 23, HERACROSS,  COUNTER, LEER, HORN_ATTACK, CUT
	db 23, PIKACHU,    TAIL_WHIP, THUNDERSHOCK, QUICK_ATTACK, HEADBUTT
	db 24, SANDSLASH,  SWIFT, ROLLOUT, MAGNITUDE, POISON_STING
	db -1 ; end
...
WillGroup:
	...
	db 41, JYNX,       DOUBLESLAP, SPORE, ICE_PUNCH, PSYCHIC_M
...
BrockGroup:
	...
	db 41, BALTOY,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
...
ScientistGroup:
	...
	db 30, LEAFEON,    CONVERSION, CONVERSION2, RECOVER, TRI_ATTACK
	db -1 ; end
...
PokemaniacGroup:
	...
	db 36, LEAFEON,    RECOVER, PSYCHIC_M, CONVERSION2, TRI_ATTACK
	db -1 ; end
...
HikerGroup:
	; HIKER (DevilsShaftB1F)
	db "STIKONY@", TRAINERTYPE_NORMAL
	db 7, SANDSHREW
	db 8, SHROOMISH
	db -1 ; end
...
BlackbeltGroup:
	...
	db 27, HITMONLEE,  DOUBLE_KICK, POISON_JAB, JUMP_KICK, FOCUS_ENERGY
	db -1 ; end
