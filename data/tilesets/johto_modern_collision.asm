	...
	tilecoll WALL, HOP_LEFT, WALL, HOP_LEFT ; 68
	tilecoll HOP_RIGHT, WALL, HOP_RIGHT, WALL ; 69
	tilecoll WALL, UP_WALL, WALL, HOP_LEFT ; 6a
	tilecoll UP_WALL, WALL, HOP_RIGHT, WALL ; 6b
	tilecoll WALL, HOP_DOWN_LEFT, WALL, WALL ; 6c
	tilecoll HOP_DOWN_RIGHT, WALL, WALL, WALL ; 6d
