...
; Johto
	...
	db LANDMARK_TOROMA_TOWN,      SPAWN_TOROMA
	db LANDMARK_PEWTER_CITY, SPAWN_CHERRYGROVE
	db LANDMARK_ORMALI_CITY,      SPAWN_ORMALI
	db LANDMARK_PEWTER_CITY,      SPAWN_AZALEA
	db LANDMARK_GOLDENROD_CITY,   SPAWN_GOLDENROD
	db LANDMARK_PEWTER_CITY,    SPAWN_ECRUTEAK
	db LANDMARK_PEWTER_CITY,     SPAWN_OLIVINE
	db LANDMARK_CIANWOOD_CITY,    SPAWN_CIANWOOD
	db LANDMARK_PEWTER_CITY,    SPAWN_MAHOGANY
	db LANDMARK_PEWTER_CITY,     SPAWN_LAKE_OF_RAGE
	db LANDMARK_PEWTER_CITY,  SPAWN_BLACKTHORN
	db LANDMARK_PEWTER_CITY,      SPAWN_MT_SILVER
; Kanto
