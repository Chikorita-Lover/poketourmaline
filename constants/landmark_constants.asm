...
; Johto landmarks
	const LANDMARK_TOROMA_TOWN
	const LANDMARK_ROUTE_3
	const LANDMARK_DEVILS_SHAFT
	const LANDMARK_ORMALI_OUTSKIRTS
	const LANDMARK_ORMALI_CITY
	const LANDMARK_ROUTE_1
	const LANDMARK_UNION_CAVE
	const LANDMARK_GOLDENROD_CITY
	const LANDMARK_ROUTE_4
	const LANDMARK_ESMARA_TOWN
	const LANDMARK_ILEX_FOREST
	const LANDMARK_ROUTE_5
	const LANDMARK_TOPARA_TOWN
	const LANDMARK_SHINAIA_FOREST
	const LANDMARK_SHINAIA_TOWN
	const LANDMARK_ROUTE_2
	const LANDMARK_CIANWOOD_CITY
	const LANDMARK_MOUNT_VOLATTE
