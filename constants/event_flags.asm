...
; Johto story events
	...
	const EVENT_GOT_MYSTIC_WATER_IN_CHERRYGROVE ; unused
...
; Johto hidden items
	...
	const EVENT_DARK_CAVE_ORMALI_ENTRANCE_HIDDEN_ELIXER
	...
	const EVENT_ORMALI_CITY_HIDDEN_HYPER_POTION
...
; Hiker
	const EVENT_BEAT_HIKER_STIKONY
...
; Bug Catcher
	const EVENT_BEAT_MYCOMANIAC_DON
	const EVENT_BEAT_MYCOMANIAC_ROB
	const EVENT_BEAT_MYCOMANIAC_ED
	const EVENT_BEAT_MYCOMANIAC_WADE
	const EVENT_BEAT_MYCOMANIAC_BENNY
	const EVENT_BEAT_MYCOMANIAC_AL
	const EVENT_BEAT_MYCOMANIAC_JOSH
	const EVENT_BEAT_MYCOMANIAC_ARNIE
	const EVENT_BEAT_MYCOMANIAC_KEN
	const EVENT_BEAT_MYCOMANIAC_WADE2
	const EVENT_BEAT_MYCOMANIAC_WADE3
	const EVENT_BEAT_MYCOMANIAC_DOUG
	const EVENT_BEAT_MYCOMANIAC_ARNIE2
	const EVENT_BEAT_MYCOMANIAC_ARNIE3
; Officer
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_MYCOMANIAC_WAYNE
...
; Johto itemballs
	...
	const EVENT_ROUTE_3_ANTIDOTE
	const EVENT_DEVILS_SHAFT_B1F_POKE_BALL
	const EVENT_ORMALI_OUTSKIRTS_EVERSTONE
	const EVENT_ORMALI_CITY_RARE_CANDY
	...
	const EVENT_DARK_CAVE_ORMALI_ENTRANCE_POTION
	const EVENT_DARK_CAVE_ORMALI_ENTRANCE_FULL_HEAL
	const EVENT_DARK_CAVE_ORMALI_ENTRANCE_HYPER_POTION
...
; Johto people
	const EVENT_RIVAL_TOROMA_TOWN
	const EVENT_RIVAL_CHERRYGROVE_CITY ; unused
	...
	const EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE ; unused
	const EVENT_ELMS_AIDE_IN_ORMALI_POKEMON_CENTER
...
; New to Crystal
	...
	const EVENT_DARK_CAVE_ORMALI_ENTRANCE_DIRE_HIT
