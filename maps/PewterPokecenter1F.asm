	...
	const PEWTERPOKECENTER1F_MYCOMANIAC
...
PewterPokecenter1FMycomaniacScript:
	jumptextfaceplayer PewterPokecenter1FMycomaniacText
...
PewterPokecenter1FMycomaniacText:
	text "Most #MON get"
	line "drowsy if they"
...
PewterPokecenter1F_MapEvents:
	...
	object_event  2,  3, SPRITE_MYCOMANIAC, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, PewterPokecenter1FMycomaniacScript, -1
