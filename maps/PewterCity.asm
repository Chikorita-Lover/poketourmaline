...
PewterCityMycomaniacScript:
	jumptextfaceplayer PewterCityMycomaniacText
...
PewterCity_MapEvents:
	...
	object_event 14, 29, SPRITE_MYCOMANIAC, SPRITEMOVEDATA_WANDER, 2, 2, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, PewterCityMycomaniacScript, -1
