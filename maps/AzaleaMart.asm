...
AzaleaMartMycomaniacScript:
	jumptextfaceplayer AzaleaMartMycomaniacText
...
AzaleaMart_MapEvents:
	...
	object_event  7,  2, SPRITE_MYCOMANIAC, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 2, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, AzaleaMartMycomaniacScript, -1
